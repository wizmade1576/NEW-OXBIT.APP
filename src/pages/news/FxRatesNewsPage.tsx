...
import { fetchFx, getProvider, type NewsItem } from '../../lib/news/providers'
  ...
  return (
    <section className="space-y-6">
      <div className="flex items-end justify-between">
        <div>
          <h3 className="text-xl font-semibold">환율/외환 뉴스</h3>
          <p className="text-muted-foreground text-sm">미국달러 환율, 각국 외환 동향</p>
        </div>
